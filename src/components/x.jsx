    ...
    return (
        <div className="" id="home">
            ...
            <div className="bg-black h-screen max-w-[1200px] mx-auto flex items-center justify-center bg-cover bg-center bg-[url('images/home.png')] sm:bg-none" id="home">
                ...
                {/* Text overlay */}
                <div className="relative z-20 p-4 text-center text-white sm:p-6 md:w-9/12 xl:w-6/12 md:text-left xl:p-0">
                    {/* Responsive Heading with breakpoints */}
                    <h1 className="mb-2 text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl">
                        <span ref={typedElement}></span>
                    </h1>

                    {/* Responsive Paragraph with breakpoints */}
